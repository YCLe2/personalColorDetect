...
bool is_spr(const std::vector<float>& hsv_s, const std::vector<float>& a) {
    std::vector<float> spr_s_std = {18.59296, 30.30303, 25.80645};
    std::vector<float> fal_s_std = {27.13987, 39.75155, 37.5};
...
bool is_smr(const std::vector<float>& hsv_s, std::vector<float>& a) {
    std::vector<float> smr_s_std = {12.5, 21.7195, 24.77064};
    std::vector<float> wnt_s_std = {16.73913, 24.8276, 31.3726};
...
int main() {
    std::vector<string> seasons = {"nspring", "nsummer", "nfall", "nwinter"};
